...
Compatability is defined in the compatability.yml. There are a few default compatability settings. To add a new setting, simply add a new entry and specify if SSL is required or not following the same format as those already there.
