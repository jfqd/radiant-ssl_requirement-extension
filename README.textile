...
If you use the "sitemap_xml":http://blog.aissac.ro/radiant/sitemap-xml-extension/ or "mailer":https://github.com/radiant/radiant-mailer-extension extensions, ssl_requirement need to be loaded after it.
